...
export default class RectangleSelection extends Module {
  ...
  private enableModuleBindings(): void {
    ...
    this.listeners.on(
      document.body,
      "mousemove",
      _.throttle((mouseEvent: MouseEvent) => {
  ...
  private processMouseDown(mouseEvent: MouseEvent): void {
    // I don't need that functionality at all;
    return;
    ...
    const startedFromContentEditable =
      (mouseEvent.target as Element).closest($.allInputsSelector) !== null;
